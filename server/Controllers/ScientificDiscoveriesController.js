...
export const create = async (req, res) => {
    try {
        ...
        const item = new ScientificDiscoveries({
            title,
        ...
        await addAdminAction(user._id, `Создал(а) научное открытие: "${title}"`);
        ...
        console.log("Ошибка в ScientificDiscoveriesController.create:", error);
        res.status(500).json({
            success: false,
...
export const getAll = async (req, res) => {
    try {
        ...
        const items = await ScientificDiscoveries.find(filter).sort({ order: 1, createdAt: -1 });
        ...
        console.log("Ошибка в ScientificDiscoveriesController.getAll:", error);
        res.status(500).json({
            success: false,
...
export const getById = async (req, res) => {
    try {
        ...
        const item = await ScientificDiscoveries.findById(id);
        ...
        console.log("Ошибка в ScientificDiscoveriesController.getById:", error);
        res.status(500).json({
            success: false,
...
export const update = async (req, res) => {
    try {
        ...
        const item = await ScientificDiscoveries.findByIdAndUpdate(
            id,
            updateData,
        ...
        await addAdminAction(user._id, `Обновил(а) научное открытие: "${item.title}"`);
        ...
        console.log("Ошибка в ScientificDiscoveriesController.update:", error);
        res.status(500).json({
            success: false,
...
export const remove = async (req, res) => {
    try {
        ...
        const item = await ScientificDiscoveries.findByIdAndDelete(id);
        ...
        await addAdminAction(user._id, `Удалил(а) научное открытие: "${item.title}"`);
        ...
        console.log("Ошибка в ScientificDiscoveriesController.remove:", error);
        res.status(500).json({
            success: false,
