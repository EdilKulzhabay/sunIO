...
export const ConsciousnessLibraryForm = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try { if (id) { await api.put(`/api/consciousness-library/${id}`, formData); toast.success('Запись обновлена'); } else { await api.post('/api/consciousness-library', formData); toast.success('Запись создана'); } navigate('/admin/consciousness-library'); }
