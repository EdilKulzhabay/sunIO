...
export const MastersTowerForm = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try { if (id) { await api.put(`/api/masters-tower/${id}`, formData); toast.success('Запись обновлена'); } else { await api.post('/api/masters-tower', formData); toast.success('Запись создана'); } navigate('/admin/masters-tower'); }
            ...
            <div className="max-w-6xl mx-auto space-y-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="bg-white rounded-lg shadow-sm p-6 space-y-4">
                        ...
                        <MyInput label="Ссылка перехода (если задана — при нажатии откроется эта страница вместо контента)" type="text" value={formData.redirectToPage} onChange={(e) => setFormData({ ...formData, redirectToPage: e.target.value })} placeholder="/client/health-lab или /client/masters-tower/:id" />
