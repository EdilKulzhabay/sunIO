...
export const HealthLabAdmin = () => {
    ...
    const handleCreate = () => {
        navigate('/admin/health-lab/create');
    };

    const handleEdit = (item: any) => {
        navigate(`/admin/health-lab/edit/${item._id}`);
    };
    ...
    const handleDelete = async (item: any) => {
        ...
        try {
            await api.delete(`/api/health-lab/${item._id}`);
        ...
        <AdminLayout>
            <div className="space-y-6">
                <div className="flex justify-between items-center">
                    <h1 className="text-3xl font-bold text-gray-900">Лаборатория здоровья</h1>
                    <button
