...
/** Та же структура, что у ParablesOfLife — единый шаблон списка/карточки и UnifiedVideoContentPage. */
const NeuromeditationSchema = new mongoose.Schema(
  {
    title: {
      type: String,
    ...
    content: [
      {
        video: {
          mainUrl: { type: String, trim: true, default: null },
          reserveUrl: { type: String, trim: true, default: null },
...
export default mongoose.model('Neuromeditation', NeuromeditationSchema);
