...
export const create = async (req, res) => {
    try {
        ...
        await addAdminAction(user._id, `Создал(а) притчу: "${title}"`);
        ...
        console.log("Ошибка в ParablesOfLifeController.create:", error);
        res.status(500).json({
            success: false,
...
export const getAll = async (req, res) => {
    try {
        ...
        const items = await ParablesOfLife.find(filter).sort({ order: 1, createdAt: -1 });
        ...
        console.log("Ошибка в ParablesOfLifeController.getAll:", error);
        res.status(500).json({
            success: false,
...
export const getById = async (req, res) => {
    try {
        ...
        const item = await ParablesOfLife.findById(id);
        ...
        console.log("Ошибка в ParablesOfLifeController.getById:", error);
        res.status(500).json({
            success: false,
...
export const update = async (req, res) => {
    try {
        ...
        const item = await ParablesOfLife.findByIdAndUpdate(
            id,
            updateData,
        ...
        await addAdminAction(user._id, `Обновил(а) притчу: "${item.title}"`);
        ...
        console.log("Ошибка в ParablesOfLifeController.update:", error);
        res.status(500).json({
            success: false,
...
export const remove = async (req, res) => {
    try {
        ...
        const item = await ParablesOfLife.findByIdAndDelete(id);
        ...
        await addAdminAction(user._id, `Удалил(а) притчу: "${item.title}"`);
        ...
        console.log("Ошибка в ParablesOfLifeController.remove:", error);
        res.status(500).json({
            success: false,
