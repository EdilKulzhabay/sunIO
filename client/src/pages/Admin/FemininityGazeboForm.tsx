...
export const FemininityGazeboForm = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try { if (id) { await api.put(`/api/femininity-gazebo/${id}`, formData); toast.success('Запись обновлена'); } else { await api.post('/api/femininity-gazebo', formData); toast.success('Запись создана'); } navigate('/admin/femininity-gazebo'); }
