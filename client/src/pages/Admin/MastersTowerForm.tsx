...
interface ContentItem { type: 'video' | 'text' | 'image' | 'linkButton'; video?: { mainUrl: string; reserveUrl: string; duration: number; }; text?: string; image?: string; linkButton?: LinkButtonValue | null; }
